...
import { ErrorCodeEnum, ErrorCodeEnumType } from "@/config/error.code.enum"
...
export class HttpExpection extends AppError {
...
export class BadRequestException extends AppError {
    constructor(message = "Bad Reqest", errorCode?:ErrorCodeEnumType){
        super(message, HTTPSTATUS.BAD_REQUEST, errorCode || ErrorCodeEnum.VALIDATION_ERROR)
    }
}


export class UnauthrizedException extends AppError {
