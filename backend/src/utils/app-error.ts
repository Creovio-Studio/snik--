import { HttpStatusType, HTTPSTATUS } from "../config/http.config";
...
export class HttpException extends AppError {
    constructor(message = "Http Exception Error", statusCode:HttpStatusType, errorCode?:ErrorCodeEnumType){
...
export class UnauthorizedException extends AppError {
    constructor(message = "Unauthrized Access", errorCode?:ErrorCodeEnumType){
